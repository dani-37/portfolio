export default function Hero() {
  return (
    <div className="absolute inset-0 p-12 md:p-14 flex flex-col justify-between">
      {/* Name wordmark */}
      <div>
        <span className="block font-grotesk font-light text-[13px] tracking-[5px] uppercase text-[#888] mb-1">
          daniel
        </span>
        <span className="block font-syne font-bold text-[clamp(36px,8vw,58px)] leading-none tracking-[-1.5px] text-ink">
      ...
      <div className="flex flex-col gap-[9px]">
        {[
          ...
          <div key={label} className="flex items-center gap-3">
            ...
            <span className="font-grotesk font-light text-[11px] text-[#666]">{label}</span>
          </div>
        ))}
      </div>
      ...
      <div>
        <p className="font-mono text-[7px] text-[#aaa] tracking-[2px] mb-4">
        ...
        <div className="flex gap-3">
          {[
            ...
            <a
              ...
              className="font-grotesk text-[9px] text-[#888] border border-[#d8d4cc] px-3 py-[5px] hover:border-green-deep hover:text-green-deep transition-colors"
            >
              {label}
            </a>
          ))}
