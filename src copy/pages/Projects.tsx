    ...
    <div className="flex flex-col items-end">
      <Link to={name.replace(/\s+/g, "-")} className="cursor-pointer group">
        <ul className="w-full flex justify-end">
          <li
            className="font-mono text-3xl w-min group-hover:underline group-hover:cursor-pointer md:group-hover:italic md:group-hover:translate-x-1 text-nowrap"
            style={{
    ...
    <>
      {isBaseRoute ? (
        <div className="text-right w-full space-y-10">
          <div className="md:hidden font-mono text-3xl w-full border-b-2 mb-12 mt-60">
            Projects
          </div>

          <Project
            name="nature footprints"
            description="modelling / sustainability"
          />
