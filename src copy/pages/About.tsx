...
const About = () => {
  return (
    <div className="text-right md:w-3/4 flex flex-col justify-end items-end cursor-default">
      ...
      <div className="space-y-3 font-aptos md:text-[1.15rem] text-gray-200">
        <p>
          I am a statistician focused on sustainable development. I transform
          data into climate action by blending analysis, visualizations, and
          sustainability strategy.
        </p>
        <p>
          I hold an MSCi from Imperial College London in Mathematics and
          Statistics. Currently, I work for{" "}
          <a
            href="https:/klere.uk/"
            target="_blank"
          ...
          (a sustainability consultancy) while completing an MSc in AI for
          Sustainable Development at UCL.
        </p>
      </div>
